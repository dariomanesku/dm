...
#       undef DM_PLATFORM_H_HEADER_GUARD
#   endif // if (DM_INCL & DM_INCL_HEADER_BODY_OPT_REMOVE_HEADER_GUARD)
#   ifndef DM_PLATFORM_H_HEADER_GUARD
#   define DM_PLATFORM_H_HEADER_GUARD
    ...
    #   undef  DM_CRT_GLIBC
    #   define DM_CRT_GLIBC (__GLIBC__ * 10000 + __GLIBC_MINOR__ * 100)
    #endif // defined(__GLIBC__)

#   endif // DM_PLATFORM_H_HEADER_GUARD
