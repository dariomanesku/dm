...
namespace dm
{
    ...
    template <typename Ty> struct TyInfo { static bool      Max() { return false;       } enum { MaxVal = false       }; };
    template <> struct TyInfo<bool>      { static bool      Max() { return true;        } enum { MaxVal = true        }; };
    template <> struct TyInfo<char>      { static char      Max() { return CHAR_MAX;    } enum { MaxVal = CHAR_MAX    }; };
    template <> struct TyInfo<uint8_t>   { static uint8_t   Max() { return UINT8_MAX;   } enum { MaxVal = UINT8_MAX   }; };
    template <> struct TyInfo<uint16_t>  { static uint16_t  Max() { return UINT16_MAX;  } enum { MaxVal = UINT16_MAX  }; };
    template <> struct TyInfo<uint32_t>  { static uint32_t  Max() { return UINT32_MAX;  } enum { MaxVal = UINT32_MAX  }; };
    template <> struct TyInfo<uint64_t>  { static uint64_t  Max() { return UINT64_MAX;  } enum { MaxVal = UINT64_MAX  }; };
    template <> struct TyInfo<int8_t>    { static int8_t    Max() { return INT8_MAX;    } enum { MaxVal = INT8_MAX    }; };
    template <> struct TyInfo<int16_t>   { static int16_t   Max() { return INT16_MAX;   } enum { MaxVal = INT16_MAX   }; };
    template <> struct TyInfo<int32_t>   { static int32_t   Max() { return INT32_MAX;   } enum { MaxVal = INT32_MAX   }; };
    template <> struct TyInfo<int64_t>   { static int64_t   Max() { return INT64_MAX;   } enum { MaxVal = INT64_MAX   }; };
    template <> struct TyInfo<void*>     { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<bool*>     { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<char*>     { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<uint8_t*>  { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<uint16_t*> { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<uint32_t*> { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<uint64_t*> { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<int8_t*>   { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<int16_t*>  { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<int32_t*>  { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<int64_t*>  { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<float*>    { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
    template <> struct TyInfo<double*>   { static uintptr_t Max() { return UINTPTR_MAX; } enum { MaxVal = UINTPTR_MAX }; };
